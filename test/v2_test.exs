defmodule PasetoPlugTest.V2 do
  ...
  defmodule KeyProvider do
    ...
    def local_key_provider do
      <<56, 165, 237, 250, 173, 90, 82, 73, 227, 45, 166, 36, 121, 213, 122, 227, 188, 168, 248,
        190, 39, 11, 243, 40, 236, 206, 123, 237, 189, 43, 220, 66>>
    end
  end
  ...
  describe "V2 Plug Tests" do
    test "Invalid V2 local token" do
      conn =
        ...
        |> put_req_header(
          "authorization",
          "Bearer v2.local.VGhpcyBpcyBhIHRlc3QgbWVzc2FnZSe-sJyD2x_fCDGEUKDcvjU9y3jRHxD4iEJ8iQwwfMUq5jUR47J15uPbgyOmBkQCxNDydR0yV1iBR-GPpyE-NQw"
        )
    ...
    test "Invalid V2 public token" do
      conn =
        ...
        |> put_req_header(
          "authorization",
          "Bearer v2.public.VGhpcyBpcyBhIHRlc3QgbWVzc2FnZSe-sJyD2x_fCDGEUKDcvjU9y3jRHxD4iEJ8iQwwfMUq5jUR47J15uPbgyOmBkQCxNDydR0yV1iBR-GPpyE-NQw"
        )
